            ...
            if (
                ...
                scrim.slots.forEach((team, index) => {
                    ...
                    if (
                        ...
                        msg.channel.send("You already registered team: **" + teamName + "**\nYour slot is: **" + (index + 3) + "**").catch(err => console.error("Error happened."));
                    ...
                    if (
                        ...
                        msg.channel.send("Team with tag **" + teamTag + "** is already registered!").catch(err => console.error("Error happened."));
                ...
                if (scrim.number_of_teams == scrim.max_number_of_teams) {
                    ...
                    msg.channel.send("⬇️ __**WAITLIST**__ ⬇️").catch(err => console.error("Error happened."));
